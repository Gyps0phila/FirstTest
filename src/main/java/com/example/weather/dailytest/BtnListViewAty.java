...
//        }
        ...
        bean1.setFuncDescription("com.example.weather.sensor.SensorAty");
        funcList.add(bean1);

        FuncBean bean2 = new FuncBean();
        bean2.setResId(R.mipmap.item1);
        bean2.setFuncDescription("com.example.weather.animation.AnimationAty");
        funcList.add(bean2);

        FuncBean bean3 = new FuncBean();
        bean3.setResId(R.mipmap.item2);
        bean3.setFuncDescription("com.example.weather.title.TitleAty1");
        funcList.add(bean3);
        adapter = new FuncAdapter(this, funcList);

        FuncBean bean4 = new FuncBean();
        bean4.setResId(R.mipmap.item11);
        bean4.setFuncDescription("com.example.weather.msg.MsgAty");
        funcList.add(bean4);

        FuncBean bean5 = new FuncBean();
        bean5.setResId(R.mipmap.item9);
        bean5.setFuncDescription("com.example.weather.fragmentpractice.NewsAty");
        funcList.add(bean5);

        FuncBean bean6 = new FuncBean();
        bean6.setResId(R.mipmap.item1);
        bean6.setFuncDescription("com.example.weather.notification.NotificationAty2");
        funcList.add(bean6);

        FuncBean bean7 = new FuncBean();
        bean7.setResId(R.mipmap.item1);
        bean7.setFuncDescription("com.example.weather.sms.SMS_ReceivedAty");
        funcList.add(bean7);

        FuncBean bean8 = new FuncBean();
        bean8.setResId(R.mipmap.item10);
        bean8.setFuncDescription("com.example.weather.takephoto.TakePhotoAty");
        funcList.add(bean8);

        FuncBean bean9 = new FuncBean();
        bean9.setResId(R.mipmap.item11);
        bean9.setFuncDescription("com.example.weather.player.MediaPlayerAty");
        funcList.add(bean9);

        FuncBean bean10 = new FuncBean();
        bean10.setResId(R.mipmap.item11);
        bean10.setFuncDescription("com.example.weather.player.VideoPlayerAty");
        funcList.add(bean10);

        FuncBean bean11 = new FuncBean();
        bean11.setResId(R.mipmap.item11);
        bean11.setFuncDescription("com.example.weather.service.MyIntentServiceAty");
        funcList.add(bean11);

        FuncBean bean12 = new FuncBean();
        bean12.setResId(R.mipmap.item11);
        bean12.setFuncDescription("com.example.weather.service.LongRunningServiceAty");
        funcList.add(bean12);
